...
sudo apt-get install -y python3-testresources curl build-essential git libffi-dev libssl-dev default-libmysqlclient-dev libpython3-dev python3-pip python3-dev unzip wget cron
